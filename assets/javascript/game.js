...
var youWin = [
	"You win!  You get an egg!"
];
var youLose = [
	"Sorry, your chickens are now gone!"
];
var emptyAlert = [
	""
];
//Describing letters will be chosen upon release of the letter key.  Valid letters described above
...
//If statements below indicating a winner or loser based on number of errors
...
//allow for 10 losses
	...
	for (var i = 0; i < alertLineElements.length; i++) {
		alertLineElements[i].textContent = (this.gameOver ? pressAnyKeyToReset[i] : pressAnyKeyToStart[i]);
	}
